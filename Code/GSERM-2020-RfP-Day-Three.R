...
# Day Two
#
# File created 6/16/2020
#
# File last modified 6/16/2020
######################################
# setwd() first:
#
...
temp<-getURL("https://raw.githubusercontent.com/PrisonRodeo/GSERM-2020-git/master/Data/flintstones.csv")
...
temp<-getURL("https://raw.githubusercontent.com/PrisonRodeo/GSERM-2020-git/master/Data/LittleDahl.csv")
...
temp<-getURL("https://raw.githubusercontent.com/PrisonRodeo/GSERM-2020-git/master/Data/ANES-pilot-2016.csv")
...
temp<-getURL("https://raw.githubusercontent.com/PrisonRodeo/GSERM-2020-git/master/Data/Justices.csv")
...
temp<-getURL("https://raw.githubusercontent.com/PrisonRodeo/GSERM-2020-git/master/Data/NAFTA.csv")
...
stargazer(NAFTA.GLM.probit,NAFTA.GLM.fit,
          type="latex",
          title="Probit and Logit Models of the NAFTA Vote",
          dep.var.caption="",
